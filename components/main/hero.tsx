    ...
    return (
        <section className="bg-main-bg py-16">
            <div className="container mx-auto text-center px-4">
                ...
                <p className="text-5xl font-bold text-action-default mb-8">All Your Products in One Place</p>
                <p className="text-xl text-text-secondary mb-10 max-w-[83.33%] mx-auto">
